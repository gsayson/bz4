...
export function Card({ title, desc, url, github }: { title: string, desc: string, url?: string, github?: string }) {
    return (
        <div className="p-3 border border-zinc-400 dark:border-zinc-600 rounded-lg bg-zinc-100 dark:bg-zinc-800 shadow-md transition transform hover:scale-y-105 mb-4 flex justify-between align-middle items-center">
